...
(function() {
	...
	function loadpage() {
		...
		var app = angular.module('entitiesApp', ['ui.bootstrap', 'ngDialog',
				...
				'app.consumptionSummaryFunctionsFactory', 'app.genericEntityController',
		...
		app.config(function($stateProvider, $urlRouterProvider, $provide) {
			...
			$stateProvider.state('/', {
				...
				controller : 'ManageConsumptionSummaryController'
			}).state('edit', {
				url : '/:uuid',
				views : {
					'' : {
						templateUrl : 'entity.page',
						controller : 'ConsumptionSummaryController'
					}
				}
			}).state('new', {
				url : '/',

...
(function () {
    ...
    app.service('ARVPharmacyDispenseFunctions', ARVPharmacyDispenseFunctions);

    ARVPharmacyDispenseFunctions.$inject = ['EntityFunctions','$filter'];

    function ARVPharmacyDispenseFunctions(EntityFunctions,$filter) {
        var service;

...
//                }
                ...
                //an empty pack size should resolve to null and not empty string
                 if(!angular.isDefined($scope.entity.packSize) || $scope.entity.packSize === ''){
                    $scope.entity.packSize = null;
                }

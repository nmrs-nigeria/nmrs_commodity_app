		...
		function addMessageLabels() {
			...
			messages['openhmis.inventory.item.minimumQuantity'] = emr
					.message('openhmis.inventory.item.minimumQuantity');
                        messages['openhmis.inventory.item.unitOfMeasure'] = emr
					.message('openhmis.inventory.item.unitOfMeasure');
                        messages['openhmis.inventory.item.packSize'] = emr
					.message('openhmis.inventory.item.packSize');

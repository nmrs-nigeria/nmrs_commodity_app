...
(function() {
	...
	/* Define model fields */
	function OperationModel(GenericMetadataModel) {
		...
		extended.getModelFields = function() {
			var fields = ["operationNumber", "instanceType",
				...
				"department", "items", "status", "patient","disposedType",
                                "adjustmentKind","commoditySource","commodityType","dataSystem"];
			return fields;
		};
	...
	baseModel.factory("OperationModel", OperationModel);

	OperationModel.$inject = ['GenericMetadataModel'];

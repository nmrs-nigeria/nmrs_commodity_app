	...
	function StockTakeController($stateParams, $injector, $scope, $filter, EntityRestFactory, StockTakeModel,
		...
		self.loadStockrooms = self.loadStockrooms || function () {
			...
			self.loadDepartments = self.loadDepartments || function () {
				...
				StockTakeRestfulService.loadDepartments(INVENTORY_MODULE_NAME, self.onLoadDepartmentsSuccessful);
			}
		...
		self.loadStockDetails = self.loadStockDetails || function (stockroomUuid, stockTakeCurrentPage) {
			...
			self.loadStockDetailsDepartment = self.loadStockDetailsDepartment || function (departmentUuid, stockTakeCurrentPage) {
				...
				StockTakeRestfulService.loadStockDetailsDepartment(departmentUuid, CookiesService.get(departmentUuid + 'stockTakeCurrentPage'),

    ...
    function CrrfReportsController($stateParams, $injector, $scope, $filter, CrrfReportsModel, CrrfReportsRestfulService,
        ...
        self.bindExtraVariablesToScope = self.bindExtraVariablesToScope || function (uuid) {
            ...
            CrrfReportsFunctions.onChangeDatePicker('endDate-display', function (value) {
              ...
              CrrfReportsFunctions.onChangeDatePicker('startDate_amod-display', function (value) {
                $scope.startDate_amod = value;
            });

            CrrfReportsFunctions.onChangeDatePicker('endDate_amod-display', function (value) {
                $scope.endDate_amod = value;
            });
            
            CrrfReportsFunctions.onChangeDatePicker('startDate_stc-display', function (value) {
                $scope.startDate_stc = value;
            });

            CrrfReportsFunctions.onChangeDatePicker('endDate_stc-display', function (value) {
                $scope.endDate_stc = value;
            });

            CrrfReportsFunctions.onChangeDatePicker('stockonhandDispensary_startDate-display', function (value) {
                $scope.stockonhandDispensary_startDate = value;
            });

            CrrfReportsFunctions.onChangeDatePicker('stockonhandDispensary_endDate-display', function (value) {
                $scope.stockonhandDispensary_endDate = value;
            });

            CrrfReportsFunctions.onChangeDatePicker('stockonhandStockroom_startDate-display', function (value) {
                $scope.stockonhandStockroom_startDate = value;
            });

            CrrfReportsFunctions.onChangeDatePicker('stockonhandStockroom_endDate-display', function (value) {
        ...
        $scope.generateReport_CRFFReport = function () {
            ...
            console.log("Selected CRRF Type report: " + selectedCRRFType);
            ...
            if (parametersAreValid) {
                ...
                CrrfReportsRestfulService.getReport("modalities_dispensary_consumption", CrrfReportsFunctions.formatDate(startDate),
                        CrrfReportsFunctions.formatDate(endDate),selectedCRRFType, function (data) {

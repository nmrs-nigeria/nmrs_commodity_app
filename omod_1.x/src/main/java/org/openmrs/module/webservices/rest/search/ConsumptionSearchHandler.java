 ...
 * @author MORRISON.I
 */
public class ConsumptionSearchHandler
        extends BaseSearchHandler
        implements SearchHandler {

	private final SearchConfig searchConfig = new SearchConfig("default", ModuleRestConstants.CONSUMPTION_RESOURCE,
	        Arrays.asList("*"),
	        Arrays.asList(
	...
	public IConsumptionDataService service;

	public ConsumptionSearchHandler(IDepartmentDataService departmentService,
	    IConsumptionDataService service, IItemDataService itemService) {
	...
	public PageableResult search(RequestContext context) throws ResponseException {
		...
		if (consumptionStartDate != null && consumptionEndDate != null) {
			...
			if (department == null && item == null) {
				...
				ConsumptionSearch consumptionSearch = createConsumptionSearch(context, item,
		...
		if (consumptions == null || consumptions.isEmpty()) {
			...
			return new AlreadyPagedWithLength<Consumption>(context, consumptions, pagingInfo.hasMoreResults(),
			        pagingInfo.getTotalRecordCount());
		}

	}

	private ConsumptionSearch createConsumptionSearch(RequestContext context, Item item, Department department,
	        Date consumptionStartDate, Date consumptionEndDate) {

		ConsumptionSearch template = new ConsumptionSearch();

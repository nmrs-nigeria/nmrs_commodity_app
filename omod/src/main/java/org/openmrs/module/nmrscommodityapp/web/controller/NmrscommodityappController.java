 ...
 */
package org.openmrs.module.nmrscommodityapp.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.NmrscommodityappController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class NmrscommodityappController {

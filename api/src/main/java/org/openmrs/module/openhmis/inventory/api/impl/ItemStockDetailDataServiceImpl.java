		...
		for (ClosingBalanceUpdateModel cbm : closingBalanceUpdateModels) {
			...
			if (list != null && list.size() >= 1) {
				...
				String hql3 = "UPDATE ClosingBalanceUpdateModel as c set "
				        ...
				        + "atmQuantity = " + cbm.getAtmQuantity() + ", "
				        + "comPharmacyQuantity = " + cbm.getComPharmacyQuantity() + ", "
				        + "communityARTGroupsQuantity = " + cbm.getCommunityARTGroupsQuantity() + ", "
				        + "courierDeliveryQuantity = " + cbm.getCourierDeliveryQuantity() + ", "
				        + "dispensaryQuantity = " + cbm.getDispensaryQuantity() + ", "
				        + "patentMedicineStoreQuantity = " + cbm.getPatentMedicineStoreQuantity() + ", "
				        + "privateClinicsQuantity = " + cbm.getPrivateClinicsQuantity() + ", "
				        + "othersQuantity = " + cbm.getOthersQuantity() + ", "
				        + "bulkStockQuantity = " + cbm.getBulkStockQuantity() + ", "
				        + "ancQuantity = " + cbm.getAncQuantity() + ", "
				        + "comQuantity = " + cbm.getComQuantity() + ", "
				        + "eidQuantity = " + cbm.getEidQuantity() + ", "
				        + "emergQuantity = " + cbm.getEmergQuantity() + ", "
				        + "fpQuantity = " + cbm.getFpQuantity() + ", "
				        + "inpatQuantity = " + cbm.getInpatQuantity() + ", "
				        + "landdQuantity = " + cbm.getLanddQuantity() + ", "
				        + "labQuantity = " + cbm.getLabQuantity() + ", "
				        + "malQuantity = " + cbm.getMalQuantity() + ", "
				        + "mobQuantity = " + cbm.getMobQuantity() + ", "
				        + "opdQuantity = " + cbm.getOpdQuantity() + ", "
				        + "ossQuantity = " + cbm.getOssQuantity() + ", "
				        + "othQuantity = " + cbm.getOthQuantity() + ", "
				        + "paedQuantity = " + cbm.getPaedQuantity() + ", "
				        + "ppQuantity = " + cbm.getPpQuantity() + ", "
				        + "stiQuantity = " + cbm.getStiQuantity() + ", "
				        + "tbQuantity = " + cbm.getTbQuantity() + ", "
				        + "vctQuantity = " + cbm.getVctQuantity() + ", "
				        + "labStockQuantity = " + cbm.getLabStockQuantity() + " "

...
public class StockOperationSearch extends BaseObjectTemplateSearch<StockOperationTemplate> {
	...
	public void updateCriteria(Criteria criteria) {
		...
		if (operation.getAdjustmentKind() != null) {
			criteria.add(Restrictions.eq("adjustmentKind", operation.getAdjustmentKind()));
		}
		...
		if (operation.getCommodityType() != null) {
			criteria.add(Restrictions.eq("commodityType", operation.getCommodityType()));
		}
